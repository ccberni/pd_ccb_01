...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PF11     ------> ADC1_INP2
    */
    HAL_GPIO_DeInit(I2_CPU_GPIO_Port, I2_CPU_Pin);

    HAL_GPIO_DeInit(I3_CPU_GPIO_Port, I3_CPU_Pin);

    HAL_GPIO_DeInit(I1_CPU_GPIO_Port, I1_CPU_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    HAL_GPIO_DeInit(O1_CPU_GPIO_Port, O1_CPU_Pin);
